...
export function EdgeArchitectureDiagram({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <path d="M136 95 L150 95" stroke={DIAG.flowBlue} strokeWidth="2" markerEnd="url(#ea-blue)" />
      <path d="M136 385 L150 385" stroke={DIAG.flowTeal} strokeWidth="2" markerEnd="url(#ea-teal)" />
      <path d="M330 130 L400 130" stroke={DIAG.flowBlue} strokeWidth="2" markerEnd="url(#ea-blue)" />
      <text x="335" y="120" fill={DIAG.text} fontSize="10">任务约束</text>
      <path d="M330 160 C360 200, 360 240, 400 240" fill="none" stroke={DIAG.flowTeal} strokeWidth="1.8" markerEnd="url(#ea-teal)" />
      <text x="345" y="210" fill={DIAG.text} fontSize="10">多艇态势</text>
      <path d="M560 130 L720 125" stroke={DIAG.flowBlue} strokeWidth="2" markerEnd="url(#ea-blue)" />
      <text x="580" y="118" fill={DIAG.text} fontSize="10">局部航迹与编队调整</text>
      <path d="M330 385 L380 385" stroke={DIAG.lineGray} strokeWidth="1.6" />
      <path d="M560 400 L720 400" stroke={DIAG.flowTeal} strokeWidth="2" markerEnd="url(#ea-teal)" />
      <text x="580" y="390" fill={DIAG.text} fontSize="10">无法局部解决</text>
      <path d="M330 200 L330 250 L560 250 L720 140" fill="none" stroke={DIAG.flowBlue} strokeWidth="1.6" markerEnd="url(#ea-blue)" />
      <text x="600" y="230" fill={DIAG.text} fontSize="10">局部处置指令</text>
      <path d="M330 100 C500 40, 600 40, 720 100" fill="none" stroke={DIAG.flowTeal} strokeWidth="1.6" markerEnd="url(#ea-teal)" />
      <text x="520" y="48" fill={DIAG.text} fontSize="10">任务进度</text>

      <g transform="translate(16, 500)">
        <text fill={DIAG.lineGray} fontSize="11">
          边侧仅掌握分管水域近实时态势 · 不承担跨任务全局规划与长周期档案管理
        </text>
      </g>
    </svg>
  )
